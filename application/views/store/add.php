        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">
                  <!-- Create Store -->
                  <?php echo 'Create Store'//$this->lang->line('add_location_header');?> 
              </h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo base_url();?>Store/add" method="post" id="myform1" class="form-horizontal" name="locationForm">
            
                <div class="form-group">
                  <label class="col-sm-2 control-label require" for="inputEmail3">        <!-- Location Name -->
                      <?php echo 'Store Name'//$this->lang->line('lbl_warehouse_name');?>
                ...
                <div class="form-group">
                  <label class="col-sm-2 control-label require" for="inputEmail3">
                      <!-- Store Code -->
                      <?php echo 'Store Code'//$this->lang->line('lbl_warehouse_code');?>
                    <span class="text-danger">*</span>
                  </label>
